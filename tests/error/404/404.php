...
<body style="color:#decba4">
<br><br><center>LOL</center><br><br>
<img src="../tests/Views/icons/giphy.gif" alt="Kitten" style="margin:auto;display:block;border:0.2px solid #decba4;border-radius:10px" width="350px" height ="250px" class ="kitten_icon" >

<h1 style="text-align:center">Try again</h1>
