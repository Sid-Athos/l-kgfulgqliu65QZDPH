<div id="txtHint"></div><div class="row">
<div class="col-xs-6" style="margin-left:15px;color:#decba4;margin-top:80px;height:110;margin-bottom:50px">
<?php
echo'
<caption><center>Vos patients</center></caption>
<table class="table-scroll table-striped"><thead><tr><th>Nom : </th><th>Espèce :</th><th>Numéro patient </th><th>Sexe </th><th>Date de naissance</th><th>Poids (kg)</th><th>Diagnostic récent</th><th style="width:350px">Historique</th></tr></thead>
<tbody>';
