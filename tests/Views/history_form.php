<div id="txtHint" style="margin:auto;margin-top:50px;display:inline-block"></div>
<div class ="row">
<div class="col-xs-12" style="margin:auto;margin-top:50px;display:inline-block">
<select class="form-control space-bottom" onclick="getHistory()" id="animal" style="width:auto;display:block;margin-auto;margin-top:5px;margin-left:35px"name="target" required>
<?php 
...
<center style="color:#decba4">
    Ajouter/modifier un historique :<br> <pre><textarea rows="8" cols="60" style="font-size:14px"id="history" name="history"/><?php if(!empty($patients_rows)){ printf($patients_rows[0]['history']);} ?></textarea></pre><br>
