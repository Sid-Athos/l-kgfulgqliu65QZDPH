...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  Dim 08 juil. 2018 à 16:14
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `category` enum('artiste','auditeur','admin') NOT NULL,
  PRIMARY KEY (`user_ID`)
...
INSERT INTO `users` (`user_ID`, `username`, `pw`, `category`) VALUES
(666, 'adminmystudio', 'administration', 'admin');
